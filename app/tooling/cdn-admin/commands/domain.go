...
func addAppLayer(domain string) error {
	const basePath = "app/services/cdn-api/handlers"

	app, err := fs.Sub(templates, "templates/cdn-api/app")
	if err != nil {
...
func addBusinessLayer(domain string) error {
	...
	app, err := fs.Sub(templates, "templates/cdn-api/business")
	if err != nil {
...
func addStorageLayer(domain string) error {
	...
	app, err := fs.Sub(templates, "templates/cdn-api/storage")
	if err != nil {
